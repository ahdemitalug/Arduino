...
void setup() {
  ...
  WiFi.begin("OnePlus 6", "medha123"); //Connect to your router
...
String getPage() {
  ...
  page += "<p><center><strong>Soil Sensor : </strong>";
  if(digitalRead(soilpin))
  page += "Dry</center></p></body>";
  else
  page += "Wet</center></p></body>";
  return page;
}
